(function () {
    ...
    var books = [
        ...
        {
            title: "Tina Turner: My Love Story",
            author: {
                firstName: "Tina",
                lastName: "Turner"
            }
...
/**
     ...
     *   previously. Refactor your code that creates the books array to instead use your function. */
    ...
    books.push(createBook("Selfish","Kim","Kardashian"));
    books.push(createBook("Confessions of a Teenage Heiress","Paris","Hilton"));
    books.push(createBook("A Princess Diarist","Carrie","Fisher"));
    books.push(createBook("Lady Gaga: Queen of Pop","Emily","Herbert"));
    books.push(createBook("Tina Turner: My Love Story","Tina","Turner"));
